...
do
    ...
    then
        cache='transforms'
        disabledCacheArgs='-Dorg.gradle.internal.transform-caching-disabled=dagger.hilt.android.plugin.util.AggregatedPackagesTransform,org.jetbrains.kotlin.gradle.internal.transforms.BuildToolsApiClasspathEntrySnapshotTransform,com.android.build.gradle.internal.dependency.EnumerateClassesTransform,com.android.build.gradle.internal.dependency.LibrarySymbolTableTransform,com.android.build.gradle.internal.dependency.AarResourcesCompilerTransform,org.jetbrains.kotlin.gradle.internal.transforms.ClasspathEntrySnapshotTransform,com.android.build.gradle.internal.dependency.ExtractJniTransform'
    fi
